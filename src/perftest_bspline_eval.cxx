  ...
  struct eval {
    ...
    void operator()(int64_t ncoeffs, int64_t nsamples) {
      ...
      iganet::Options<iganet::perftests::real_t> options =
        iganet::Options<iganet::perftests::real_t>{}.requires_grad(requires_grad);
      ...
      if constexpr (BSpline::parDim() == 1) {
        ...
        if constexpr (precompute) {
          ...
          auto basfunc =
            bspline.template eval_basfunc<deriv, memory_optimized>(xi, knot_idx);
          auto coeff_idx =
      ...
      // 3D
        ...
        BSpline bspline({ncoeffs, ncoeffs, ncoeffs}, iganet::init::linear, options);
      ...
      // 4D
        ...
        BSpline bspline({ncoeffs, ncoeffs, ncoeffs, ncoeffs}, iganet::init::linear, options);
  ...
  for (int64_t ncoeffs : {10, 100, 1000}) {
    for (int64_t nsamples : {1, 10, 100, 1000, 10000, 25000, 50000, 100000,
      ...
      std::apply([&](auto&&... args) {((args(ncoeffs, nsamples)), ...);},
                 std::make_tuple(BSplinePerformanceTest::eval<iganet::UniformBSpline<iganet::perftests::real_t, 1, 1>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::UniformBSpline<iganet::perftests::real_t, 1, 2>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::UniformBSpline<iganet::perftests::real_t, 1, 3>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::UniformBSpline<iganet::perftests::real_t, 1, 4>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::UniformBSpline<iganet::perftests::real_t, 1, 5>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{}
                                 ));
...
void make_test_NonUniformBSpline_parDim1() {
  ...
  for (int64_t ncoeffs : {10, 100, 1000}) {
    for (int64_t nsamples : {1, 10, 100, 1000, 10000, 25000, 50000, 100000,
      ...
      std::apply([&](auto&&... args) {((args(ncoeffs, nsamples)), ...);},
                 std::make_tuple(BSplinePerformanceTest::eval<iganet::NonUniformBSpline<iganet::perftests::real_t, 1, 1>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::NonUniformBSpline<iganet::perftests::real_t, 1, 2>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::NonUniformBSpline<iganet::perftests::real_t, 1, 3>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::NonUniformBSpline<iganet::perftests::real_t, 1, 4>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::NonUniformBSpline<iganet::perftests::real_t, 1, 5>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{}
                                 ));
...
void make_test_UniformBSpline_parDim2() {
  ...
  for (int64_t ncoeffs : {10, 100, 1000}) {
    for (int64_t nsamples : {1, 10, 100, 1000, 10000, 25000, 50000, 100000,
      ...
      std::apply([&](auto&&... args) {((args(ncoeffs, nsamples)), ...);},
                 std::make_tuple(BSplinePerformanceTest::eval<iganet::UniformBSpline<iganet::perftests::real_t, 1, 1, 1>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::UniformBSpline<iganet::perftests::real_t, 1, 2, 2>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::UniformBSpline<iganet::perftests::real_t, 1, 3, 3>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::UniformBSpline<iganet::perftests::real_t, 1, 4, 4>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::UniformBSpline<iganet::perftests::real_t, 1, 5, 5>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{}
                                 ));
...
void make_test_NonUniformBSpline_parDim2() {
  ...
  for (int64_t ncoeffs : {10, 100, 1000}) {
    for (int64_t nsamples : {1, 10, 100, 1000, 10000, 25000, 50000, 100000,
      ...
      std::apply([&](auto&&... args) {((args(ncoeffs, nsamples)), ...);},
                 std::make_tuple(BSplinePerformanceTest::eval<iganet::NonUniformBSpline<iganet::perftests::real_t, 1, 1, 1>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::NonUniformBSpline<iganet::perftests::real_t, 1, 2, 2>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::NonUniformBSpline<iganet::perftests::real_t, 1, 3, 3>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::NonUniformBSpline<iganet::perftests::real_t, 1, 4, 4>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::NonUniformBSpline<iganet::perftests::real_t, 1, 5, 5>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{}
                                 ));
...
void make_test_UniformBSpline_parDim3() {
  ...
  for (int64_t ncoeffs : {10, 100, 1000}) {
    for (int64_t nsamples : {1, 10, 100, 1000, 10000, 25000, 50000, 100000,
      ...
      std::apply([&](auto&&... args) {((args(ncoeffs, nsamples)), ...);},
                 std::make_tuple(BSplinePerformanceTest::eval<iganet::UniformBSpline<iganet::perftests::real_t, 1, 1, 1, 1>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::UniformBSpline<iganet::perftests::real_t, 1, 2, 2, 2>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::UniformBSpline<iganet::perftests::real_t, 1, 3, 3, 3>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::UniformBSpline<iganet::perftests::real_t, 1, 4, 4, 4>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::UniformBSpline<iganet::perftests::real_t, 1, 5, 5, 5>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{}
                                 ));
...
void make_test_NonUniformBSpline_parDim3() {
  ...
  for (int64_t ncoeffs : {10, 100, 1000}) {
    for (int64_t nsamples : {1, 10, 100, 1000, 10000, 25000, 50000, 100000,
      ...
      std::apply([&](auto&&... args) {((args(ncoeffs, nsamples)), ...);},
                 std::make_tuple(BSplinePerformanceTest::eval<iganet::NonUniformBSpline<iganet::perftests::real_t, 1, 1, 1, 1>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::NonUniformBSpline<iganet::perftests::real_t, 1, 2, 2, 2>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::NonUniformBSpline<iganet::perftests::real_t, 1, 3, 3, 3>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::NonUniformBSpline<iganet::perftests::real_t, 1, 4, 4, 4>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{},
                                 BSplinePerformanceTest::eval<iganet::NonUniformBSpline<iganet::perftests::real_t, 1, 5, 5, 5>,
                                 iganet::deriv::func, memory_optimized, precompute, requires_grad, true>{}
                                 ));
